...
def free_bacon(opponent_score):
    ...
    if opponent_score < 10:
        digit = [0, opponent_score]
    else:
        digit = [opponent_score//10, opponent_score%10]
    score = 1 + max(digit)
    return score
    # END PROBLEM 2
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    pigFly_score = 25 - num_rolls
    score = min(score, pigFly_score)
    return score
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_prime(baconScore):
        baconScore = next_prime(baconScore)
    if baconScore * 2 == opponent_score:
        return 0
    elif baconScore >= margin and baconScore != opponent_score * 2:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def final_strategy(score, opponent_score):
    ...
    *** get stuck here, it does not perform well ***
    """
    # BEGIN PROBLEM 11
    max_score = 0
    max_round = 0
    for i in range(0,11):
        round_score = take_turn(i, opponent_score, select_dice(score, opponent_score, False))
    ...
    if bacon_score * 2 == opponent_score:
        inc_score = opponent_score - bacon_score
    elif bacon_score == opponent_score * 2:
        inc_score = opponent_score - bacon_score
    else:
        inc_score = bacon_score - score
